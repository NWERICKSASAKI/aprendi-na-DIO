...
A proposta é resolver os exercícios abaixos com o auxílio da GitHub Copilot, seja para explicar como se programa ou se estrutura o código em Python ou tirar eventuais dúvidas.

Fonte: <https://github.com/alinealien/resolvendo-codigos-py-copilot>
